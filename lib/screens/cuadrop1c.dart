...
class CuadroP1C extends StatefulWidget {
  String anio;
  String seccion;
  var materia1;

  CuadroP1C(this.anio, this.seccion, this.materia1, {super.key});

  @override
  State<CuadroP1C> createState() => _CuadroP1CState();
}

class _CuadroP1CState extends State<CuadroP1C> {
