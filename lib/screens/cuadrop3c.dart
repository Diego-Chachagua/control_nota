...
class CuadroP3C extends StatefulWidget {
  String anio;
  String seccion;
  var materia1;

  CuadroP3C(this.anio, this.seccion, this.materia1, {super.key});

  @override
  State<CuadroP3C> createState() => _CuadroP3CState();
}

class _CuadroP3CState extends State<CuadroP3C> {
